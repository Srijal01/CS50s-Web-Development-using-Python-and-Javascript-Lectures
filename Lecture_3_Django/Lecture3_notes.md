...
![Client and Server](images/client_server.png)
...
To get started, we'll have to install Django, which means you'll also have to [install pip](https://pip.pypa.io/en/stable/installing/) if you haven't already done so. Once you have Pip installed, you can run `pip3 install Django` in your terminal to install Django.
...
![installed apps](images/installed.png)
...
![Harry](images/harryc.png)

![Connor](images/connorc.png)
...
![template0](images/template0.png)
...
![interpreter](images/datetime.png)
