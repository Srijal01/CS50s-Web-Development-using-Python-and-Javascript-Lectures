...
One way in which JavaScript Objects are really useful is in transferring data from one site to another, particularly when using [APIs](https://www.mulesoft.com/api/what-is-an-api)
...
![Exchange demo](images/exchange.gif)
